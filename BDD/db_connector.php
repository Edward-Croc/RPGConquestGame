            ...
            if (!$exists) {
                ...
                if (isset($_POST['config_name'])) {
                    $fileNames = [
                        ...
                        'zones' => ['name', 'description', 'hide_turn_zero', 'is_hidden', 'controllers__lastname->claimer_controller_id', 'controllers__lastname->holder_controller_id', 'adjacent_zones', 'zone_rules'],
                        'locations' => ['name', 'description', 'hidden_description', 'discovery_diff', 'zones__name->zone_id', 'controllers__lastname->controller_id', 'is_base', 'can_be_destroyed', 'can_be_repaired', 'is_updated_location', 'activate_json', 'location_types'],
