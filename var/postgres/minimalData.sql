...
VALUES
    ...
    ('baseClaimAddSupportingClaimers', '1', 'Per-supporting-claimer bonus. max(0, COUNT(claimer workers in zone with action=claim) - 1) times this multiplier (mode B only)'),
