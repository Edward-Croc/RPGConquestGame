...
VALUES
    ...
    ('aiBudgetByState', '{"passive":[0,70,30],"searching":[20,50,30],"aggressive":[60,30,10],"violent":[80,10,10]}', 'Per-state action budget weights [attack,investigate,passive] for the AI state machine'),
    ('aiStrikeMarginPercent', '10', 'Required attack-vs-estimated-defence margin (%) for AI to commit a strike'),
    ('aiLocationAttackCap', '5', 'Max number of AI-issued attack actions targeting a single location per turn'),
    ('aiPowerPriorityList', 'Discipline,Transformation', 'Ordered list of power categories the AI prioritises when recruiting/training'),
    ('aiClaimPriorityByYield', 'TRUE', 'When TRUE, AI prioritises claim targets by expected resource yield'),
