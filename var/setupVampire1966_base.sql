...
INSERT INTO powers ( name, enquete, action, defence, other) VALUES
    ('Goule', 0,0,1, '{"hidden" : "1", "on_recrutment": "TRUE", "on_transformation": "FASLE" }'),
    ('Vampire nouveau né', 1,1,2, '{"hidden" : "1", "on_recrutment": "FALSE", "on_transformation": {"age": "2", "turn": "2"} }'),
    ('Szlatcha', -1,2,3, '{"hidden" : "0", "on_recrutment": "FALSE", "on_transformation": {"age": "2", "controler_power": "Vicissitude"}}'),
    ('Fantome',3,-2,3, '{"hidden" : "0", "on_recrutment": "FALSE", "on_transformation": {"woker_state": "0", "controler_power": "Nécromancie"}}'),
    ('Possession', 2,-1,2, '{"hidden" : "2", "on_recrutment": "FALSE", "on_transformation": {"OR": {"age": "2","woker_state": "0"}, "controler_faction": "Démon, Eglise"}}')
;
