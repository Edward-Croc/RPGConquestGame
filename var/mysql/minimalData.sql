...
VALUES
    ...
    -- action text in report — first-person (used in archived life_report EOT sentences)
    ('txt_ps_1p_passive', 'je surveille', 'First-person text for passive action'),
    ('txt_ps_1p_investigate', 'j''enquête', 'First-person text for investigate action'),
    ('txt_ps_1p_hide', 'je me cache', 'First-person text for hide action'),
    ('txt_ps_1p_attack', 'j''attaque', 'First-person text for attack action'),
    ('txt_ps_1p_claim', 'je revendique le quartier', 'First-person text for claim action'),
    ('txt_ps_1p_captured', 'j''ai disparu', 'First-person text for captured action'),
    ...
    -- action text in report — infinitive tense
    ...
    ('textPrisonerTransferSent', 'Nous avons envoyé ce prisonnier chez %1$s%2$s.<br />', 'Trace left at the jailer when a prisoner is transferred away. Placeholders: %1$s = controllerNameDenominatorThe, %2$s = receiving controller name.'),
    ('textPrisonerTransferReceived', 'J''ai été transféré vers %1$s%2$s, en tant que prisonnier.<br />', 'Line added to the prisoner own report on transfer. Placeholders: %1$s = controllerNameDenominatorThe, %2$s = receiving controller name.'),
    ...
    ('textLocationAssaultOwnerSuccess', '["Notre %1$s a été attaqué.e, par %2$s. Ils ont franchi les portes avec succès."]', 'Pool shown to the location owner when the attack succeeds. %1$s = location name, %2$s = the assailants, worded per locationAttackCreditMode.'),
    ('textLocationAssaultOwnerFail', '["Notre %1$s a été attaqué.e, par %2$s. Heureusement, ils ne semblent pas avoir atteint leur objectif."]', 'Pool shown to the location owner when the attack fails. Same placeholders as textLocationAssaultOwnerSuccess.'),
    ('textLocationAgeOriginal', '["Ce.tte %1$s a été construit.e %2$s."]', 'Location discovery : pool for a place that never changed state. %1$s = location name, %2$s = the age clause.'),
    ('textLocationAgeRuined', '["Ce.tte %1$s a été détruit.e par une attaque %2$s."]', 'Location discovery : pool for a place currently in ruins, awaiting repair. Same placeholders.'),
    ('textLocationAgeRestored', '["Ce.tte %1$s a été relevé.e de ses ruines %2$s."]', 'Location discovery : pool for a place that was ruined then restored. Same placeholders.'),
